...
A presente Política de Privacidade contém informações sobre coleta, uso, armazenamento, tratamento e proteção dos dados pessoais dos usuários e visitantes do site ***{{ site.title }}***, com a finalidade de demonstrar absoluta transparência quanto ao assunto e esclarecer a todos interessados sobre os tipos de dados que são coletados, os motivos da coleta e a forma como os usuários podem gerenciar ou excluir as suas informações pessoais.

Esta Política de Privacidade aplica-se a todos os usuários e visitantes do site ***{{ site.title }}*** e integra os Termos e Condições Gerais de Uso do site ***{{ site.title }}***, doravante nominada ***PLATAFORMA***.

O presente documento foi elaborado em conformidade com a Lei Geral de Proteçâo de Dados Pessoais ([Lei 13.709/18](https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm)), o Marco Civil da Internet ([Lei 12.965/14](https://www.planalto.gov.br/ccivil_03/_ato2011-2014/2014/lei/l12965.htm)) (e o Regulamento da UE n. [2016/679](https://eur-lex.europa.eu/legal-content/EN/TXT/HTML/?uri=OJ:L:2016:119:FULL&from=CS)). Ainda, o documento poderá ser atualizado em decorrência de eventual atualização normativa, razão pela qual se convida o usuário a consultar periodicamente esta seção.
...
- Quando o usuário cria uma conta/perfil na PLATAFORMA: esses dados são os dados de identificação básicos, como e-mail, nome completo, cidade de residência e profissão. A partir deles, podemos identificar o usuário e o visitante, além de garantir uma maior segurança e bem-estar às suas necessidade. Ficam cientes os usuários e visitantes de que seu perfil na plataforma estará acessível a todos demais usuários e visitantes da PLATAFORMA.

- Quando um usuário e visitante acessa as páginas da PLATAFORMA: as informações sobre interação e acesso são coletadas para garantir uma melhor experiência ao usuário e visitante. Estes dados podem tratar sobre as palavras-chaves utilizadas em uma busca, o compartilhamento de um documento específico, comentários, visualizações de páginas, perfis, a URL de onde o usuário e visitante provêm, o navegador que utilizam e seus IPs de acesso, dentre outras que poderão ser armazenadas e retidas.

- Por intermédio de terceiro: a PLATAFORMA recebe dados de terceiros, como Google, Facebook, Twitter, Linkedin e GitHub, quando um usuário faz login com o seu perfil de um desses sites. A utilização desses dados é autorizada previamente pelos usuários junto ao terceiro em questão.
...
- Dados para a criação da conta/perfil na PLATAFORMA: e-mail, nome completo, cidade de residência e profissão.
...
Os dados pessoais do usuário e do visitante coletados e armazenados pela PLATAFORMA tem por finalidade:
...
Os dados pessoais do usuário e visitante são armazenados pela PLATAFORMA durante o período necessário para a prestação do serviço ou o cumprimento das finalidades previstas no presente documento, conforme o disposto no inciso I do artigo 15 da [Lei 13.709/18](https://www.planalto.gov.br/ccivil_03/_ato2015-2018/2018/lei/l13709.htm).
...
<!-- (com as seguintes pessoas (físicas) (jurídicas): _________, CPF/CNPJ _________. -->
...
O usuário tem direito de retirar o seu consentimento a qualquer tempo, para tanto deve encerrar sua conta por meio da PLATAFORMA e remover os cookies por meio do seu navegador de internet.
...
Os eventuais litígios deverão ser apresentados no foro da comarca em que se encontra a sede da PLATAFORMA.
